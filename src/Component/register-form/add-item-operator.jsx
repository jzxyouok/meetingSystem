...
const AddCustomize = (props) => (
	<Row className="add-customize">
		<Col offset={4}>
			...
			<Button onClick={props.handle_muti_choice}><Icon type="plus" />多选</Button>
			<Button onClick={props.handle_select_choice}><Icon type="plus" />下拉框</Button>
			<Button onClick={props.handle_add_date}><Icon type="plus" />日期</Button>
			<Button onClick={props.handle_add_file}><Icon type="plus" />文件</Button>
			<Button onClick={props.handle_add_text}><Icon type="plus" />普通文本框</Button>
			<Button onClick={props.handle_add_textarea}><Icon type="plus" />多行文本框</Button>
		</Col>
	</Row>
);
