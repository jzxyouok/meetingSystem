...
import {Button, FormGroup, Col, FormControl, ControlLabel, Row, InputGroup, Label} from 'react-bootstrap';
			...
			<FormGroup bsClass="form-item form-group">
				...
				<Col sm={4} bsClass="tl imgupload col">
					<FormGroup controlId="file">
						<ControlLabel className="btn btn-primary">上传图片</ControlLabel>
						<FormControl type="file" style={{display: 'none'}}></FormControl>
					</FormGroup>
					<p>温馨提示</p>
